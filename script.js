...
const menuItems = [
  ...
  },
  {
    ...
    desc: "",
    image:
      "Images/Tandoori-Butter-Chicken.jpg",
    badge: "Popular",
    spicy: true,
    veg: false,
    glutenFree: true,
  ...
  {
    id: 7,
    name: "Tandoori Butter Chicken (Medium)",
    category: "Chef Specialities",
    price: 10.90,
    desc: "1/2 Tandoori Chicken (off the bone) cooked with butter in a thick creamy mild sauce.",
    image:"Images/Tandoori Butter-Chicken.jpg",
    badge: "Popular",
    spicy: true,
    veg: false,
    glutenFree: true,
  ...
  {
    id: 9,
    name: "Salmon Sizzling",
    category: "Chef Specialities",
    price: 15.95,
    desc: "",
    image:
      "Images/Salmon-Sizzling.webp              ",
    badge: "Best Seller",
    spicy: true,
    veg: false,
    glutenFree: true,
  ...
  {
    id: 10,
    name: "Sweet Chilli Masala",
    category: "Chef Specialities",
    price: 14.9,
    desc: "Chicken,green Peppers, onions, tomatoes, soya sauce and diffirent indian herbs & Spices in a thai indian stayle.",
    image:
      "Images/Sweet-Chilli-Chicken.jpg",
    badge: "Popular",
    spicy: true,
    veg: false,
    glutenFree: true,
  ...
  {
    id: 14,
    name: "Bengal Prawn Vegetable Curry",
    category: "Chef Specialities",
    price: 11.95,
    desc: "Chef Style",
    image:
      "Images/Bengal-Prawn-Vegetable-Curry.jpg",
    badge: "",
    spicy: true,
    veg: true,
    glutenFree: true,
  ...
  {
    id: 15,
    name: "Morgil Chaat Masala",
    category: "Chef Specialities",
    price: 11.50,
    desc: "1/2 Tandoori Chicken on the bone and minced meat marinated in a special tandoori sauce, barbecued in clay oven then sliced and cooked in a spicy hot masala sauce.",
    image:
      "Images/Morgil-Chaat-Masala.jpg",
    badge: "",
    spicy: true,
    veg: false,
    glutenFree: true,
  ...
  {
    id: 16,
    name: "King Prawn Taba",
    category: "Chef Specialities",
    price: 16.95,
    desc: "King Prawns cooked with herbs and spices,onion, tomato in semi dry gravy.",
    image:
      "Images/King-Prawn-Taba.jpg",
    badge: "New",
    spicy: false,
    veg: true,
  },
